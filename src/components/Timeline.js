...
const TimelineCard = ({ title, subtitle, footnote, isLeft }) => (
  <div className={`group relative ${isLeft ? 'text-right' : 'text-left'}`}>
    ...
    {/* Card */}
    <div className="bg-white dark:bg-surface-900 p-3 rounded-xl shadow-material-2 hover:shadow-material-3 border border-surface-200/50 dark:border-surface-700/50 transition-all duration-300 transform hover:-translate-y-1">
      {/* Period Badge */}
      {footnote && (
        <div className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-primary-100 to-secondary-100 text-primary-700 dark:from-primary-900/30 dark:to-secondary-900/30 dark:text-primary-300 border border-primary-200/50 dark:border-primary-700/50 mb-2 ${isLeft ? '' : ''}`}>
...
const MobileTimelineCard = ({ title, subtitle, footnote }) => (
  <div className="group relative">
    ...
    <div className="bg-white dark:bg-surface-900 p-3 rounded-xl shadow-material-2 hover:shadow-material-3 border border-surface-200/50 dark:border-surface-700/50 transition-all duration-300 transform hover:-translate-y-1">
      {/* Period Badge */}
      {footnote && (
        <div className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-primary-100 to-secondary-100 text-primary-700 dark:from-primary-900/30 dark:to-secondary-900/30 dark:text-primary-300 border border-primary-200/50 dark:border-primary-700/50 mb-2">
          <span className="mr-1.5">📅</span>
          {footnote}
        </div>
      )}
                ...
                <div className="hidden md:block relative" style={{zIndex: 10 - idx}}>
                  <div className="relative flex items-center">
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center z-20">
                      <div className="w-6 h-6 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full border-4 border-white dark:border-surface-900 shadow-material-2">
                      </div>
                    </div>
