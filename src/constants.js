...
export const PROJECTS_FALLBACK = [
  {
    ...
    forks_count: 7,
    language: 'Python',
    topics: ['aws', 'bedrock', 'claude', 'postgresql', 'pgvector', 'knowledge-bases', 'opentofu', 'lambda', 's3', 'rds'],
  ...
  },
  {
    ...
    forks_count: 5,
    language: 'Python',
    topics: ['aws', 'bedrock', 'claude', 'athena', 'bedrock-agents', 'sql', 'opentofu', 'structured-data', 'nlp'],
  ...
  },
  {
    ...
    forks_count: 3,
    language: 'JavaScript',
    topics: ['aws', 'cognito', 'cloudfront', 'lambda', 'react', 'terraform'],
  ...
  },
  {
    ...
    forks_count: 2,
    language: 'TypeScript',
    topics: ['aws', 'cognito', 's3', 'cloudfront', 'react', 'elastic-bean', 'amplify'],
